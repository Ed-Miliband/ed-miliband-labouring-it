...
def main_menu(): #Main menu screen
 ...
 while A = True:
   ...
   NEWGAME_BUTTON = Button (image=pygame.image.load("assets/Play Rect.png"), pos=(640, 100), text_input="NEW GAME", font=get_font (75), base_color="#d7fcd4", hovering_color="White")
